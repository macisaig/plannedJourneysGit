  ...
  <body>  
        ...
        <div class="collapse navbar-collapse myNavbar" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item d-none" id="contactMain">
              <a class="nav-link" href="#"><span class="loginNav">Contact Us</span></a>
            </li>
    ...
    <div class="limitWidth padSides">
      <div class="contactColor">
        <div class="jumbotron limitWidth jumbotronContactUs">
          <div class="container">
            <div class="row">
              <div class="col-sm-12 col-lg-12">
                <h1 class="h1">
                  Contact us <br><small>Tell Us About Your Journey</small></h1>
              </div>
            </div>
          </div>
        </div>
        <a>Visit the <a href="faq.html">FAQ</a> to get answers to frequently asked questions</a>
        ...
        <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control boldBlack" id="name" placeholder="Enter name" required="required" />
                    </div>
                    <div class="form-group">
                      <label for="email">Email Address</label>
                      <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></span>
                      <input type="email" class="form-control boldBlack" id="email" placeholder="Enter email" required="required" />
                    </div>
                    <div class="form-group">
                      <label for="subject">Subject</label>
                      <select id="subject" name="subject" class="form-control boldBlack" required="required">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea name="message" id="contactMessage" class="form-control boldBlack" rows="8" cols="25" required="required" placeholder="Message"></textarea>
                    </div>
                  </div>
          ...
          <div class="col-md-4 text-center">
            <form>
              <br>
              <legend><span class="glyphicon glyphicon-globe"></span> <strong>Voiyag</strong></legend>
              <address>
              ...
              <address>
                 <strong>Phone: </strong><br>
                      (Phone Coming in Future) <!--(123) 456-7890 -->
              </address>
              <address>
                <strong>Email: </strong><br>
                <a href="mailto:service@voiyag.com">service@voiyag.com</a>
              </address>
            </form>
          </div>
        </div>
